                                 ...
                                 const std::unordered_map<unsigned int, std::unordered_set<unsigned int>> &atom_adjacencies)
{
    ...
    {
        std::cout << "Bond: " << bond.getIdx() << " is activated :-)" << std::endl;
    }
                                                                             ...
                                                                             std::unordered_set<std::string> &seen_activations)
{
    ...
    std::cout << "begin: " << bond_bgn->getIdx() << std::endl;
    ...
    for(const auto &neighbor_atom: mol.atomNeighbors(bond_bgn))
    {
        ...
        std::cout << "Elem: " << neighbor_atom_elem << " count: " << activation_types.count(neighbor_atom_elem) << std::endl;
        ...
        if (activation_types.count(neighbor_atom_elem) > 0)
        {
            ...
            for (const auto& s : seen_activations)
            {
                std::cout << s << " ";
            }
            std::cout << std::endl;
...
int main(int argc, char *argv[])
{
    ...
    while (std::getline(input_stream, line))
    {
        ...
        for (const auto& a : atom_adjacencies)
        {
            std::cout << "adjatom idx: " << a.first << " [";
        ...
        for (const auto& a : bond_adjacencies)
        {
            std::cout << "adjbond idx: " << a.first << " [";
            for (const auto& b: a.second)
            {
                std::cout << b << " ";
            }
        ...
        std::cout << "Num bonds: " << num_bonds << std::endl;
        ...
        for (unsigned int bond_idx = 0 ; bond_idx < num_bonds ; ++bond_idx) 
        {
            ...
            {
                std::cout << "Is activated bond: " << bond_idx << std::endl;
