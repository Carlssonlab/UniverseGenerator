...
int main(int argc, char *argv[])
{
    ...
    while (std::getline(input_stream, line))
    {
        ...
        for (const auto& atom_sym : atom_symmetries)
        {
            std::cout << "Atom: " << atom_sym.first << " sym: " << atom_sym.second << std::endl;
        }
        ...
        for (const auto& sym_fact : symmetry_factors)
        {
            std::cout << "Atom: " << sym_fact.first << " fact: " << sym_fact.second << std::endl;
        }
